/**
 * Kule kayitlari telde delta olarak gidiyor.
 *
...
import { mergeDynamicTowerSnapshots } from "../packages/shared/dist/index.js";
...
test("tikanan istemci sonrasinda bir sonraki kare tam gidiyor", () => {
  ...
  const { wire } = room.applyTowerWireDelta(tam);
  assert.deepEqual(wire.towers, tam.towers, "atlanan istemciden sonra kare tam gitmedi");
});
