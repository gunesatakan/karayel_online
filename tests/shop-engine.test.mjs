...
test("catalog contains 63 valid, unique and numeric single-line items", () => {
  assert.equal(shopCatalog.length, 63);
  assert.equal(new Set(shopCatalog.map(({ id }) => id)).size, 63);
