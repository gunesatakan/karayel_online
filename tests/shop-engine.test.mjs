...
test("catalog contains 68 valid, unique and numeric single-line items", () => {
  assert.equal(shopCatalog.length, 68);
  assert.equal(new Set(shopCatalog.map(({ id }) => id)).size, 68);
