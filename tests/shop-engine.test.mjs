...
test("catalog contains 65 valid, unique and numeric single-line items", () => {
  assert.equal(shopCatalog.length, 65);
  assert.equal(new Set(shopCatalog.map(({ id }) => id)).size, 65);
