...
test("catalog contains 70 valid, unique and numeric single-line items", () => {
  assert.equal(shopCatalog.length, 70);
  assert.equal(new Set(shopCatalog.map(({ id }) => id)).size, 70);
