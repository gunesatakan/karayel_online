...
function towerToDetail(tower: TowerDefinition): DetailItem {
  ...
  if (tower.id === "warrior-2") {
    parts.push("Uzun link buff: Ayni kuleye 5 dalga bagli kalirsa impact/carpma vuruslu bagli kule Sunucu leveline gore +%12-30 hasar alir. 10 dalga bagli kalirsa bagli kulenin her vurusuna Sunucu leveline gore hedef max HP'sinin %0.5-1.5'i kadar ek hasar eklenir.");
  }
