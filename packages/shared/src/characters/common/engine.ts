...
const profiles: Record<string, EngineProfile> = {
  ...
  "archer-3": { targeting: "first", attack: { shape: "circle", radius: 42 }, canHitAir: false, statusEffects: [{ type: "curse", magnitude: 1, durationMs: 0, stacking: "add" }], stacks: [{ id: "curse-pool", trigger: "hit", stat: "storedDamage", perStack: 1 }], triggers: [{ event: "kill", effect: "death-burst" }], resources: { ammoType: "auraCrystal" } },
  ...
  "archer-6": { targeting: "first", attack: { shape: "circle", radius: 40 }, canHitAir: true, statusEffects: [{ type: "slow", magnitude: 0.1, durationMs: 0, stacking: "add", maxStacks: 3 }, { type: "stun", magnitude: 1, durationMs: 350, stacking: "none" }], stacks: [{ id: "doubt", trigger: "hit", stat: "slow", perStack: 0.1, max: 3 }], resources: { ammoType: "auraCrystal" } },
