...
export const atakanSkills = makeSkills("warrior", [
  ["Yonlendirme", "Basili tutup surukleyerek bir alan secer. 3 saniye boyunca mermi vuruslu kuleler menzil sinirina takilmadan o alandaki dusmanlara saldirir; alandaki dusmanlar %30 fazla hasar alir.", 16000],
