...
export const shopCatalog: ShopItem[] = [
  ...
  globalItem("kristal-rafinerisi", "Kristal Rafinerisi", "Güç kristali kullanan kulelerin yakıt tüketimi -%40.", "class", 170, { scope: { kind: "tagged", ammoTypes: ["powerCrystal"] }, effects: [effect("kristal-rafinerisi", "shotFuelCost", -0.4)] }),
