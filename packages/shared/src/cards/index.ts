...
export const cardCatalog: CardDefinition[] = [
  ...
  { id: "sirt-kayisi", name: "Sırt Kayışı", description: "İşçi taşıma kapasitesi +%35 ama yürüme hızı -%10.", axes: ["economy"], scope: { kind: "global" }, stackable: true, maxStacks: 2, rarity: "uncommon", effects: [effect("sirt-kayisi", "workerCapacity", 0.35), effect("sirt-kayisi", "workerSpeed", -0.1)] },
  ...
  // --- Kontrol ve nisan ---
  // Bes kart, bes ayri sey. Hicbiri otekini gerektirmiyor ve hicbiri
  // otekiyle birlikte cikmayi beklemiyor: her biri sahada zaten olan bir
