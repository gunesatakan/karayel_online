...
export const cardCatalog: CardDefinition[] = [
  ...
  { id: "ek-yuva", name: "Ek Yuva", description: "Kule kapasitesi +1, en fazla 3 kez.", axes: ["economy"], scope: { kind: "global" }, stackable: true, maxStacks: 3, effects: [effect("ek-yuva", "towerCapacity", 1)] },
