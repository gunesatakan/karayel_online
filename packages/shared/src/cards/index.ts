...
export const cardCatalog: CardDefinition[] = [
  ...
  { id: "seri-atis", name: "Seri Atış", description: "Bir kulenin atış hızı +%20, yakıt tüketimi +%35.", axes: ["dps"], scope: { kind: "targeted" }, stackable: true, effects: [effect("seri-atis", "fireRate", 0.2, "tower"), effect("seri-atis", "shotFuelCost", 0.35, "tower")] },
  ...
  { id: "verimli-namlu", name: "Verimli Yakıt", description: "Tüm kulelerin yakıt tüketimi -%30.", axes: ["economy"], scope: { kind: "global" }, stackable: false, effects: [effect("verimli-namlu", "shotFuelCost", -0.3)] },
