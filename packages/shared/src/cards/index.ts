...
export const cardCatalog: CardDefinition[] = [
  ...
  { id: "seri-atis", name: "Seri Atış", description: "Bir kulenin atış hızı +%20, kendi atış yakıtı +%35.", axes: ["dps"], scope: { kind: "targeted" }, stackable: true, effects: [effect("seri-atis", "fireRate", 0.2, "tower"), effect("seri-atis", "ammoCost", 0.35, "tower"), effect("seri-atis", "energyCost", 0.35, "tower")] },
  ...
  { id: "verimli-namlu", name: "Verimli Yakıt", description: "Tüm kulelerin atış yakıtı tüketimi -%30.", axes: ["economy"], scope: { kind: "global" }, stackable: false, effects: [effect("verimli-namlu", "ammoCost", -0.3), effect("verimli-namlu", "energyCost", -0.3)] },
